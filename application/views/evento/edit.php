...
<form id="formAdd" class="form-horizontal">
    <fieldset>
        ...
        <input type="text" class="span2" value="<?php echo $hoy?>" data-date-format="yyyy-mm-dd" id="dp1" name="fecha_inicio" value="<?=$evento['fecha_inicio']?>">

        <h5>Fecha de termino</h5>
        <input type="text" class="span2" value="<?php echo $hoy?>" data-date-format="yyyy-mm-dd" id="dp2" name="fecha_fin" value="<?=$evento['fecha_fin']?>"><br />
