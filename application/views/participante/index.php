...
<?php echo form_open('participante/index') ?>
...
<form id="formIndex" method="post">
    <fieldset>
        ...
        <table class="table table-striped table-bordered tablesorter" id="tableParticipantes">
            <thead>
            <tr>
            ...
            <? foreach($participantes as $participante): ?>
                <tr>
                    <td align="center"><?=$participante['id']?></td>
        ...
        <input name="id_participante" type="hidden" id="id_participante"/>
    </fieldset>
</form>
